...
def get_input_label(BATCH_SIZE, START, label_origin):
    ...
    for i in range(BATCH_SIZE):
        ...
        img = cv2.resize(img,(MAX_LENGTH, Threshold))
...
def get_train_model():
    ...
    #seq_len = tf.convert_to_tensor(np.int32(np.array([750,750,750])))
...
def train():
    ...
    def do_batch():
        ...
        # seq_len_generated = session.run([seq_len], feed)
        # print(seq_len)
        # print(tf.shape(seq_len))
        # print(type(seq_len))
        #print b_loss
